with
    ...
    trial_converted as (
        ...
        select visitors_tests_type_1.*, deduped_trial_converted.goal_name

        from visitors_tests_type_1

        left join
            deduped_trial_converted
            on deduped_trial_converted.goals_mduid = visitors_tests_type_1.visitors_mduid
    ),
